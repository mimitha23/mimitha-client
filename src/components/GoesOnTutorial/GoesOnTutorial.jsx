...
export default function GoesOnTutorial() {
  ...
  return (
    <Styled.GoesOn>
      <div className="generator">
        ...
        <button className="generate-btn" style={{ position: "relative" }}>
          generate
          {state.explainGenerate && (
            <Explain
              step="explainGenerate"
      ...
      <div className="generator_result">
        ...
        <ResultActions
          explainBuyNow={state.explainBuyNow}
          explainAddToCart={state.explainAddToCart}
        />
      </div>
    </Styled.GoesOn>
  );
